                         ...
                         <ul>
                            ...
                            <li class="has-dropdown">
                               ...
                               <ul class="submenu">
                                  ...
                                  <li><a href="{{url('detail')}}">Shop Details </a></li>                                  <li><a href="details-2.html">Shop Details 2</a></li>
                               ...
                               <ul class="submenu mega-menu">
                                  <li>
                                     ...
                                     <ul>
                                        ...
                                        <li><a href="details.html">Shop sidebar</a></li>
                                        <li><a href="details-2.html">Shop Right sidebar</a></li>
                   ...
                   <ul>
                      ...
                      <li class="has-dropdown">
                         ...
                         <ul class="submenu">
                            ...
                            {{-- <li><a href="details-2.html">Shop Details 2</a></li>
                            <li><a href="shop-location.html">Shop Location</a></li> --}}
                            <li><a href="{{asset('cart')}}">Cart</a></li>
                            <li><a href="sign-in.html">Sign In</a></li>
                            <li><a href="{{url('checkout')}}">Checkout</a></li>
    ...
    <div class="tpcart__product">
          ...
          <ul>
             <li>
                <div class="tpcart__item">
                   ...
                   <div class="tpcart__content">
                      <span class="tpcart__content-title"><a href="details.html">Miko Wooden Bluetooth Speaker</a>
                      </span>
             ...
             <li>
                <div class="tpcart__item">
                   ...
                   <div class="tpcart__content">
                      <span class="tpcart__content-title"><a href="details.html">Evo Lightweight Granite Shirt</a>
                      </span>
                      <div class="tpcart__cart-price">
                         <span class="quantity">1 x</span>
       ...
       <div class="tpcart__checkout">
          ...
          <div class="tpcart__checkout-btn">
             <a class="tpcart-btn mb-10" href="{{asset('cart')}}">View Cart</a>
