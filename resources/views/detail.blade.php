                    ...
                    <div class="d-flex align-items-start">
                       <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                         ...
                         <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                             <img src="{{asset('front/assets/img/product/home-one/product-2.jpg')}}" alt="">
                          </button>
                 ...
                 <div class="tpproduct-details__condation">
                    <ul>
                       <li>
                          <div class="tpproduct-details__condation-item d-flex align-items-center">
                             <div class="tpproduct-details__condation-thumb">
                                <img src="{{asset('front/assets/img/icon/product-det-1.png')}}" alt="" class="tpproduct-details__img-hover">
                             </div>
                       ...
                       <li>
                          <div class="tpproduct-details__condation-item d-flex align-items-center">
                             <div class="tpproduct-details__condation-thumb">
                                <img src="{{asset('front/assets/img/icon/product-det-2.png')}}" alt="" class="tpproduct-details__img-hover">
                             </div>
                             <div class="tpproduct-details__condation-text">
                       ...
                       <li>
                          <div class="tpproduct-details__condation-item d-flex align-items-center">
                             <div class="tpproduct-details__condation-thumb">
                                <img src="{{asset('front/assets/img/icon/product-det-3.png')}}" alt="" class="tpproduct-details__img-hover">
                             </div>
                             <div class="tpproduct-details__condation-text">
                       ...
                       <li>
                          <div class="tpproduct-details__condation-item d-flex align-items-center">
                             <div class="tpproduct-details__condation-thumb">
                                <img src="{{asset('front/assets/img/icon/product-det-4.png')}}" alt="" class="tpproduct-details__img-hover">
                             </div>
                             <div class="tpproduct-details__condation-text">
                             ...
                             <div class="latest-comments mb-55">
                                <ul>
                                   <li>
                                      <div class="comments-box d-flex">
                                         <div class="comments-avatar mr-25">
                                            <img src="{{asset('front/assets/img/shop/reviewer-01.png')}}" alt="">
                                         </div>
                                   ...
                                   <li>
                                      <div class="comments-box d-flex">
                                         <div class="comments-avatar mr-25">
                                            <img src="{{asset('front/assets/img/shop/reviewer-02.png')}}" alt="">
                                         </div>
                                         <div class="comments-text">
                                            <div class="comments-top d-sm-flex align-items-start justify-content-between mb-5">
                                               <div class="avatar-name">
                                   ...
                                   <li>
                                      <div class="comments-box d-flex">
                                         <div class="comments-avatar mr-25">
                                            <img src="{{asset('front/assets/img/shop/reviewer-03.png')}}" alt="">
                                         </div>
                                         <div class="comments-text">
                                            <div class="comments-top d-sm-flex align-items-start justify-content-between mb-5">
                                               <div class="avatar-name">
              ...
              <div class="swiper-wrapper">
                    ...
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          <a href="shop-details-2.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-1.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-2.jpg')}}" alt="">
                          </a>
                    ...
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          <a href="shop-details.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-3.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-4.jpg')}}" alt="">
                          </a>
                          <div class="tpproduct__thumb-action">
                             <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                             <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                 ...
                 <div class="swiper-slide">
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          <a href="shop-details-2.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-5.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-6.jpg')}}" alt="">
                          </a>
                          <div class="tpproduct__thumb-action">
                             <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                             <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                 ...
                 <div class="swiper-slide">
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          ...
                          <a href="shop-details-2.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-7.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-8.jpg')}}" alt="">
                          </a>
                          <div class="tpproduct__thumb-action">
                             <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                             <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                 ...
                 <div class="swiper-slide">
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          <a href="shop-details-2.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-9.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-10.jpg')}}" alt="">
                          </a>
                          <div class="tpproduct__thumb-action">
                             <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                             <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                 ...
                 <div class="swiper-slide">
                    <div class="tpproduct pb-15 mb-30">
                       <div class="tpproduct__thumb p-relative">
                          ...
                          <a href="shop-details-2.html">
                             <img src="{{asset('front/assets/img/product/home-one/product-11.jpg')}}" alt="product-thumb">
                             <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-12.jpg')}}" alt="">
                          </a>
                          <div class="tpproduct__thumb-action">
                             <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                             <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
