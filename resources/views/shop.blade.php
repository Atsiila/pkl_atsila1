...
@section('content')
     ...
     <!-- breadcrumb-area -->
     <section class="breadcrumb__area pt-60 pb-60 tp-breadcrumb__bg" data-background="{{asset('front/assets/img/banner/breadcrumb-01.jpg')}}">
        <div class="container">
                             ...
                             <div class="tpproduct__thumb">
                                <div class="tpproduct__thumbitem p-relative">
                                   <a href="shop-details.html">
                                      <img src="{{asset('front/assets/img/product/home-two/product-21.jpg')}}" alt="product-thumb">
                                      <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-22.jpg')}}" alt="">
                                   </a>
                                </div>
                             </div>
                          </div>
                             ...
                             <div class="tpproduct__thumb">
                                <div class="tpproduct__thumbitem p-relative">
                                   <a href="shop-details-2.html">
                                      <img src="{{asset('front/assets/img/product/home-two/product-23.jpg')}}" alt="product-thumb">
                                      <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-24.jpg')}}" alt="">
                                   </a>
                                </div>
                             </div>
                          </div>
                       ...
                       <div class="row mb-40">
                          <div class="col-lg-4 col-md-12">
                             <div class="tpproduct__thumb">
                                <div class="tpproduct__thumbitem p-relative">
                                   <a href="shop-details-2.html">
                                      <img src="{{asset('front/assets/img/product/home-two/product-25.jpg')}}" alt="product-thumb">
                                      <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-26.jpg')}}" alt="">
                                   </a>
                                </div>
                             </div>
                          </div>
                       ...
                       <div class="row mb-40">
                          <div class="col-lg-4 col-md-12">
                             <div class="tpproduct__thumb">
                                <div class="tpproduct__thumbitem p-relative">
                                   <a href="#">
                                      <img src="{{asset('front/assets/img/product/home-two/product-27.jpg')}}" alt="product-thumb">
                                      <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-28.jpg')}}" alt="">
                                   </a>
                                </div>
                             </div>
                          </div>
                             ...
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-21.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-22.jpg')}}" alt="product-thumb">
                                      </a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-31.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-32.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                             ...
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-27.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-28.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                             ...
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-25.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-26.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-29.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-30.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-33.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-34.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                             ...
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-23.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-24.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-35.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-36.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-37.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-38.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                          ...
                          <div class="col">
                             <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                   <div class="tpproduct__thumbitem p-relative">
                                      <a href="shop-details-2.html">
                                         <img src="{{asset('front/assets/img/product/home-two/product-39.jpg')}}" alt="product-thumb">
                                         <img class="thumbitem-secondary" src="{{asset('front/assets/img/product/home-two/product-40.jpg')}}" alt="product-thumb">
                                      </a>
                                      <div class="tpproduct__thumb-bg">
                                         <div class="tpproductactionbg">
                                            <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
